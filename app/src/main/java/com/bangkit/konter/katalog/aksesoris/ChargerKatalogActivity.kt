package com.bangkit.konter.katalog.aksesoris
...
import com.bangkit.konter.katalog.voucher.UpdateVoucherActivity
import com.google.firebase.firestore.DocumentSnapshot
import com.google.firebase.firestore.FirebaseFirestore

class ChargerKatalogActivity : AppCompatActivity() {
        ...
        katalogAdapter = KatalogAdapter(filteredList,
            onEditClicked = { voucher ->
                ...
                val intent = Intent(this, UpdateVoucherActivity::class.java).apply {
                    ...
                    putExtra("collectionName", "charger")  // Kirimkan koleksi
                }
    ...
    private fun fetchVouchersFromFirestore() {
        val telkomselTask = firestore.collection("charger").get()
