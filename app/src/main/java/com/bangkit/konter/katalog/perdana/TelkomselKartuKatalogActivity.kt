package com.bangkit.konter.katalog.perdana
...
class TelkomselKartuKatalogActivity : AppCompatActivity() {
        ...
        katalogAdapter = KatalogAdapter(filteredList,
            onEditClicked = { voucher ->
                ...
                val intent = Intent(this, UpdateVoucherActivity::class.java).apply {
                    ...
                    putExtra("collectionName", "k.telkomsel")  // Kirimkan koleksi
                }
    ...
    private fun fetchVouchersFromFirestore() {
        val telkomselTask = firestore.collection("k.telkomsel").get()
    ...
    private fun deleteVoucherFromFirestore(voucherId: String) {
        firestore.collection("k.telkomsel")
            .document(voucherId)
            .delete()
